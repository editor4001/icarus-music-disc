...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    public static final List<ItemLike> SAPPHIRE_SMELTABLE = List.of(ModItems.RAW_SAPPHIRE.get(),
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        oreBlasting(pWriter, SAPPHIRE_SMELTABLE , RecipeCategory.MISC,ModItems.SAPPHIRE.get(), 25.0f,200,"sapphire");
        oreSmelting(pWriter, SAPPHIRE_SMELTABLE , RecipeCategory.MISC,ModItems.SAPPHIRE.get(), 25.0f,100,"sapphire");
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,ModBlocks.SAPPHIRE_ORE.get(), 9)
    ...
    protected static void oreCooking(Consumer<FinishedRecipe> p_250791_, RecipeSerializer<? extends AbstractCookingRecipe> p_251817_, List<ItemLike> p_249619_, RecipeCategory p_251154_, ItemLike p_250066_, float p_251871_, int p_251316_, String p_251450_, String p_249236_) {
        for(ItemLike itemlike : p_249619_) {
            SimpleCookingRecipeBuilder.generic(Ingredient.of(itemlike), p_251154_, p_250066_, p_251871_, p_251316_, p_251817_)
                    ...
                    .save(p_250791_, Icarus_music_disc.MODID + ":" + getItemName(p_250066_) + p_249236_ + "_" + getItemName(itemlike));
        }
